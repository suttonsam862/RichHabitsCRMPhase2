import { pgTable, varchar, text, jsonb, timestamp, boolean, foreignKey, unique, numeric, uuid, date, bigserial, integer, check, primaryKey, pgEnum } from "drizzle-orm/pg-core"
