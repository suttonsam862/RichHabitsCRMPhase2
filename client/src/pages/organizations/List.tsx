                  ...
                  <div className="px-4 pb-4 flex gap-2 h-12">
                    {needsSetup && canManageOrgSetup(org.id) ? (
                      ...
                      <>
                        ...
                        <Link 
                          className="flex-1 flex items-center justify-center text-xs rounded-md bg-gradient-to-r from-cyan-500/20 to-purple-500/20 border border-cyan-500/30 hover:border-cyan-400 transition-all duration-200 font-medium"
                        ...
                        <Link 
                          className="flex-1 flex items-center justify-center text-xs rounded-md bg-white/5 border border-white/10 hover:border-white/20 transition-all duration-200 font-medium"
                      ...
                      <>
                        <Link 
                          className="flex-1 flex items-center justify-center text-sm rounded-md bg-gradient-to-r from-cyan-500/20 to-purple-500/20 border border-cyan-500/30 hover:border-cyan-400 transition-all duration-200 font-medium"
                          to={`/organizations/${org.id}`}
                          data-testid={`link-view-${org.id}`}
                        >
                          View
                        ...
                        <Link 
                          className="flex-1 flex items-center justify-center text-sm rounded-md bg-white/5 border border-white/10 hover:border-white/20 transition-all duration-200 font-medium"
                          to={`/organizations/${org.id}/edit`}
                          data-testid={`link-edit-${org.id}`}
                        >
                          Edit
